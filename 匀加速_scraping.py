...
if __name__ == '__main__':
    ...
    with open('all_goods_list.p', 'rb') as f:
        old = pickle.load(f)
    ...
    #all_goods_dict = get_all_goods_info()
    
    #start_url = 'http://www.15yunmall.com/companyProduct/index'
    
    #company_info_link = get_link(start_url)
    
    #company_goods = []
    
    #count = 297
    
    #for i in company_info_link:
        #company_goods.append(get_link(i))
        #count -= 1
        #print(count)
    ...
    #for i in range(len(link_list)):
        #for j in range(len(link_list[i])):
            #new_link.extend(get_link(link_list[i][j]))
            #print(i, j)
    ...
    #for i in range(len(link_list)):
        #for j in range(len(link_list[i])):
            #link_list[i][j] = get_link(link_list[i][j])  
            #print(i, j)
    
    #with open('all_link_yunjiasu.json', 'w') as f:
        #json.dump(link_list, f)
    
    
    #url = 'http://www.15yunmall.com/goods/detail/162.html'
    #good_dict, good_list = get_good_info(url)
